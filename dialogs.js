...
window.titles = {
  ...
  stagingprojectintegration: "Staging Project Integration",
  ...
  factoryintegration: "Factory Integration",
...
window.descriptions = {
  ...
  factoryintegration: "<ul><li><strong>Type:</strong> Action</li><li><strong>Role:</strong> Factory Maintainer</li></ul><p>Continuous process to ensure that Factory is solid enough to be used in a daily basis by contributors and for creating Factory-Tested and the ISOs.</p>",
